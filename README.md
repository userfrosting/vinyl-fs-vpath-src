...
| Branch | Status |
| ------ | ------ |
| master | [![Build Status](https://github.com/userfrosting/vinyl-fs-vpath/workflows/.github/workflows/ci.yml/badge.svg?branch=master)](https://github.com/userfrosting/vinyl-fs-vpath/actions) [![Build Status](https://travis-ci.org/userfrosting/vinyl-fs-vpath.svg?branch=master)](https://travis-ci.org/userfrosting/vinyl-fs-vpath) [![codecov](https://codecov.io/gh/userfrosting/vinyl-fs-vpath/branch/master/graph/badge.svg)](https://codecov.io/gh/userfrosting/vinyl-fs-vpath/branch/master) |
| develop | [![Build Status](https://github.com/userfrosting/vinyl-fs-vpath/workflows/.github/workflows/ci.yml/badge.svg?branch=develop)](https://github.com/userfrosting/vinyl-fs-vpath/actions) [![Build Status](https://travis-ci.org/userfrosting/vinyl-fs-vpath.svg?branch=develop)](https://travis-ci.org/userfrosting/vinyl-fs-vpath) [![codecov](https://codecov.io/gh/userfrosting/vinyl-fs-vpath/branch/develop/graph/badge.svg)](https://codecov.io/gh/userfrosting/vinyl-fs-vpath/branch/develop) |
